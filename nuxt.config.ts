...
export default defineNuxtConfig({
  ...
  app: {
    ...
    head: {
      ...
      meta: [
        ...
        { property: 'og:title', content: 'Tools.tomacheese.com - 便利なWebツール集' },
        { property: 'og:description', content: 'カラーピッカー、文字数カウンター、数学計算など、日常的に使える便利なWebツールを提供しています。無料で安全なブラウザ上で動作するオンラインツール集です。' },
        { property: 'og:locale', content: 'ja_JP' },
        
        // Twitter Card
        { name: 'twitter:card', content: 'summary' },
        { name: 'twitter:title', content: 'Tools.tomacheese.com - 便利なWebツール集' },
        { name: 'twitter:description', content: 'カラーピッカー、文字数カウンター、数学計算など、日常的に使える便利なWebツールを提供しています。' },
      ],
      link: [
  ...
  // Sitemap
  sitemap: {
    hostname: process.env.DEPLOY_ENV === 'GH_PAGES' 
