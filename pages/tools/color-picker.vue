  ...
  <div class="tool-content">
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-bottom: 2rem;">
      ...
      <div>
        ...
        <input
          ...
          type="color"
          style="width: 100%; height: 100px; border: none; border-radius: 6px; cursor: pointer;"
        />
      </div>
      ...
      <div>
        ...
        <div
          ...
          style="width: 100%; height: 100px; border-radius: 6px; border: 1px solid #e2e8f0; position: relative;"
        >
          <div style="position: absolute; bottom: 8px; left: 8px; background: rgba(0,0,0,0.7); color: white; padding: 4px 8px; border-radius: 4px; font-size: 0.875rem;">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1rem; margin-top: 2rem;">
      <div class="result-box">
        ...
        <div style="font-family: 'Courier New', monospace; font-size: 1.25rem; font-weight: bold; margin-bottom: 0.5rem;">
          {{ selectedColor.toUpperCase() }}
        </div>
        <button
    ...
    <div style="margin-top: 2rem;">
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(60px, 1fr)); gap: 0.5rem;">
        <div
          ...
          style="height: 60px; border-radius: 6px; cursor: pointer; border: 2px solid transparent; transition: border-color 0.2s;"
          :class="{ 'border-blue-500': selectedColor.toUpperCase() === color.toUpperCase() }"
          :title="color"
    ...
    <div style="margin-top: 2rem; padding: 1rem; background: #f8fafc; border-radius: 6px;">
      ...
      <ul style="margin-left: 1.5rem; color: #64748b;">
        ...
        <li>各形式のコピーボタンでカラーコードをクリップボードにコピーできます</li>
...
const commonColors = [
  ...
  '#FFA500', '#FFC0CB', '#FFD700', '#ADFF2F', '#FF6347', '#40E0D0', '#EE82EE', '#87CEEB',
  '#F0F8FF', '#FAEBD7', '#F5F5DC', '#FFE4E1', '#DCDCDC', '#D3D3D3', '#A9A9A9', '#696969'
]
...
useHead({
  ...
  meta: [
    { name: 'description', content: 'HEX、RGB、HSLなど様々な形式でカラーコードを取得・変換できるカラーピッカーツールです。' },
    { name: 'keywords', content: 'カラーピッカー, 色, HEX, RGB, HSL, カラーコード, 色選択' }
  ]
})
</script>
