  ...
  <div class="tool-content">
    ...
    <div v-if="result !== null" class="result-section">
      ...
      <div class="result-box">
        <div style="margin-bottom: 1.5rem;">
          <div style="font-size: 1.5rem; font-weight: 600; color: #1e293b; margin-bottom: 0.5rem;">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem; margin-bottom: 1.5rem;">
          <div>
            ...
            <div style="font-size: 0.9rem;">
              ...
              <div v-if="inputNumber <= 20">正確な値: {{ result.toLocaleString() }}</div>
            </div>
          </div>
        ...
        <div v-if="inputNumber > 0 && inputNumber <= 10">
          ...
          <div style="background: #f1f5f9; padding: 1rem; border-radius: 6px; font-family: 'Courier New', monospace;">
    ...
    <div style="margin-top: 2rem;">
      ...
      <div class="result-box">
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1rem;">
          <div>
            <h4 style="color: #2563eb; margin-bottom: 0.5rem;">小さな数の階乗</h4>
            <div style="max-height: 300px; overflow-y: auto;">
              <table style="width: 100%; border-collapse: collapse;">
                <thead>
                  <tr style="background: #f8fafc;">
                    <th style="padding: 0.5rem; text-align: left; border: 1px solid #e2e8f0;">n</th>
                    <th style="padding: 0.5rem; text-align: left; border: 1px solid #e2e8f0;">n!</th>
                  </tr>
                </thead>
                <tbody>
                  <tr
                    ...
                    :key="n.value"
                    :style="{ 
                      backgroundColor: n.value === inputNumber ? '#dbeafe' : 'transparent',
                      cursor: 'pointer'
                    }"
                    @click="selectFactorial(n.value)"
                  >
                    <td style="padding: 0.5rem; border: 1px solid #e2e8f0; font-family: 'Courier New', monospace;">
                      {{ n.value }}
                    </td>
                    <td style="padding: 0.5rem; border: 1px solid #e2e8f0; font-family: 'Courier New', monospace; font-size: 0.875rem;">
          ...
          <div>
            <h4 style="color: #2563eb; margin-bottom: 0.5rem;">大きな数の階乗（近似）</h4>
            <div style="max-height: 300px; overflow-y: auto;">
              <table style="width: 100%; border-collapse: collapse;">
                <thead>
                  <tr style="background: #f8fafc;">
                    <th style="padding: 0.5rem; text-align: left; border: 1px solid #e2e8f0;">n</th>
                    <th style="padding: 0.5rem; text-align: left; border: 1px solid #e2e8f0;">n! (指数表記)</th>
                  </tr>
                </thead>
                <tbody>
                  <tr
    ...
    <div style="margin-top: 2rem; padding: 1rem; background: #f8fafc; border-radius: 6px;">
      ...
      <ul style="margin-left: 1.5rem; color: #64748b; margin-bottom: 1rem;">
        ...
        <li>階乗は非常に急速に増加し、170!以上はJavaScriptでInfinityになります</li>
...
useHead({
  ...
  meta: [
    { name: 'description', content: '指定した数値の階乗を計算します。計算過程の表示や階乗表の確認も可能です。' },
    { name: 'keywords', content: '階乗計算, factorial, 数学, 組み合わせ, 順列' }
  ]
})
</script>