<template>
  <div class="tool-content">
    ...
    <div style="display: flex; flex-wrap: wrap; gap: 1rem; margin-bottom: 2rem; padding: 1rem; background: #f8fafc; border-radius: 6px;">
      ...
      <div style="margin-left: auto; display: flex; align-items: center; gap: 1rem;">
        <label style="display: flex; align-items: center; gap: 0.5rem;">
          ...
          <select v-model="indentSize" class="form-select" style="width: auto; padding: 0.5rem;">
    ...
    <div class="form-group">
      ...
      ></textarea>
      <div v-if="validationError" style="color: #dc2626; font-size: 0.875rem; margin-top: 0.5rem;">
    ...
    <div style="margin-top: 2rem; padding: 1rem; background: #f8fafc; border-radius: 6px;">
      ...
      <ul style="margin-left: 1.5rem; color: #64748b; margin-bottom: 1rem;">
        <li><strong>整形:</strong> JSONを読みやすい形式にインデントを付けて整形します</li>
        <li><strong>圧縮:</strong> 不要な空白や改行を削除してサイズを最小化します</li>
        <li><strong>検証:</strong> JSON形式の妥当性をチェックしてエラーを表示します</li>
...
useHead({
  ...
  meta: [
    { name: 'description', content: 'JSONデータを見やすく整形・バリデーションするオンラインツールです。統計情報の表示やエラー検出も可能です。' },
    { name: 'keywords', content: 'JSON, 整形, フォーマット, バリデーション, 検証, 圧縮, 統計' }
  ]
})
</script>
