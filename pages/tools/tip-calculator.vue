      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1rem; margin-bottom: 2rem;">
        ...
        <div>
          ...
          <div class="form-group">
            ...
            <select v-model="serviceQuality" class="form-select" @change="applyServiceQuality">
        ...
        <div>
          ...
          <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 0.5rem;">
            ...
            >
              ...
              <div style="font-size: 0.75rem; opacity: 0.8;">{{ quickTip.label }}</div>
            </button>
          </div>

          <div style="margin-top: 1rem;">
            <h4 style="margin-bottom: 0.5rem; color: #1e293b; font-size: 1rem;">プリセット</h4>
    ...
    <div v-if="isValidInput && result" style="margin-top: 2rem;">
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem;">
        ...
        <div class="result-box" style="border-left: 4px solid #ef4444;">
          <h4 style="color: #2563eb; margin-bottom: 0.5rem;">チップ（一人当たり）</h4>
          <div style="text-align: center;">
      ...
      <div class="result-box" style="margin-top: 1rem;">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1rem;">
          ...
          <div>
            <h5 style="font-weight: 600; margin-bottom: 0.5rem;">一人当たり詳細</h5>
            <div style="font-size: 0.9rem; line-height: 1.6;">
              <div style="display: flex; justify-content: space-between;">
                <span>請求額:</span>
...
const presets = [
  ...
  { name: '高級レストラン (¥15,000, 2人)', billAmount: 15000, people: 2, tip: 22 }
]

// 計算プロパティ
const isValidInput = computed(() => {
  return billAmount.value !== null && 
         billAmount.value > 0 && 
...
const result = computed(() => {
  ...
  return calculateTip(billAmount.value, tipPercentage.value, numberOfPeople.value)
})
...
useHead({
  ...
  meta: [
    { name: 'description', content: 'レストランなどでのチップ額を簡単に計算します。サービス品質別の目安も提供。' },
    { name: 'keywords', content: 'チップ計算, レストラン, サービス料, 海外旅行, マナー' }
  ]
})
</script>
