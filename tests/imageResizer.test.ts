...
describe('imageResizer', () => {
  ...
  describe('generateFilename', () => {
    it('should generate filename with suffix', () => {
      ...
      expect(generateFilename('test.gif', 'png', 'small')).toBe('test_small.png')
    })

    it('should handle filenames with multiple dots', () => {
      expect(generateFilename('my.photo.jpg', 'jpeg')).toBe('my.photo_resized.jpeg')
      expect(generateFilename('file.min.js.map', 'png')).toBe('file.min.js_resized.png')
    })
  })
})