...
describe('Health Utils', () => {
  describe('calculateBMI', () => {
    ...
    it('should categorize underweight correctly', () => {
      const result = calculateBMI(45, 1.7)
    ...
    it('should categorize obesity grade 3 correctly', () => {
      const result = calculateBMI(105, 1.7)
    ...
    it('should categorize obesity grade 4 correctly', () => {
      const result = calculateBMI(120, 1.7)
    ...
    it('should throw error for invalid weight', () => {
      ...
      expect(() => calculateBMI(-10, 1.7)).toThrow(
        '身長と体重は正の数である必要があります'
      )
    })
    ...
    it('should throw error for invalid height', () => {
      ...
      expect(() => calculateBMI(70, -1.7)).toThrow(
        '身長と体重は正の数である必要があります'
      )
    })

    it('should throw error for height in cm instead of m', () => {
      expect(() => calculateBMI(70, 170)).toThrow(
        '身長はメートル単位で入力してください（例：1.70）'
      )
    })
  })
  ...
  describe('calculateBMR', () => {
    ...
    it('should throw error for invalid inputs', () => {
      expect(() => calculateBMR(0, 1.75, 30, 'male')).toThrow(
        '体重、身長、年齢は正の数である必要があります'
      )
      expect(() => calculateBMR(70, 0, 30, 'male')).toThrow(
        '体重、身長、年齢は正の数である必要があります'
      )
      expect(() => calculateBMR(70, 1.75, 0, 'male')).toThrow(
        '体重、身長、年齢は正の数である必要があります'
      )
    })
  })
