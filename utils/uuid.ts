...
export function formatUUID(uuid: string, format: 'uppercase' | 'lowercase' | 'no-hyphens'): string {
  switch (format) {
    case 'uppercase':
...
export function generateUUIDsWithOptions(options: UUIDGenerationOptions): string[] {
